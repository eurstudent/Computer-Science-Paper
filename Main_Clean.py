...
def createTokenTitleList(dataFrameTitle, filterHits):
    tokenList = []
...
threshold = 0.7  # JS threshold for being an exact pair
# CLustering
...
modelWordsTitleList = createTokenTitleList(total_df['title list'], filterHitTH)
modelWordsList = createTokenTitleList(total_df['word list'], filterHitTH2)
...
"""
print("Creating the Signature Matrix ...")
...
endSimmilarity = time.time() - tValue
print("Applying Jaccard for the similarity Matrix Done")
...
# print("minWordLength, filterHitTH, filterHitTH2, ModelWordsFeatureMap, OnlyAlphaNumeric, HashrandomvectoorBool, Size SignatureMatrix, NumberBands, Repetitions, FastLSH, CandidatePairsByModelID, Threshold")
# print(minWordLength,filterHitTH, filterHitTH2, modelWordsFeatureMap, onlyAlphaNumeric, hashRandomVectorBool, sizeSignatureMatrix, numberBands, repetitions, fastLSH, candidatePairsByModelID, threshold)
print("Hyper Parameters")
print("minWordLength: " + str(minWordLength))
print("filterHitTH: " + str(filterHitTH))
print("filterHitTH2: " + str(filterHitTH2))
print("ModelWordsFeatureMap: " + str(modelWordsFeatureMap))
print("OnlyAlphaNumeric: " + str(onlyAlphaNumeric))
print("hashRandomVectorBool: " + str(hashRandomVectorBool))
print("Size SignatureMatrix: " + str(sizeSignatureMatrix))
print("NumberBands: " + str(numberBands))
print("Repetitions: " + str(repetitions))
print("FastLSH: " + str(fastLSH))
print("Threshold: " + str(threshold))
print("Clustering Bool: " + str(clusteringBool))
print("Epsilon: " + str(epsilon))
print("-------------------------------------------------------------------")
print("LSH Scores:")
print("    Pair Quality      = " ,round(lshPairQuality,2))
print("    Pair Completeness = " ,round(lshPairCompleteness,2))
print("    F1                = " ,round(lshF1,2))
print("-------------------------------------------------------------------")
print("Post Clustering Scores:")
print("    Pair Quality      = " ,round(pairQuality,2))
print("    Pair Completeness = " ,round(pairCompleteness,2))
print("    F1                = " ,round(F1,2))
print("-------------------------------------------------------------------")
print("-------------------------------------------------------------------")
print("-------------------------------------------------------------------")
print("(b,r,n) = " + "(" +str(bands) + "," + str(rows) + "," + str(sizeSignatureMatrix) + ")")
